...
class Experiment:
    """
    Handles complete lifecycle of running a training/evaluation experiment:
    - directory creation
    - model/tokenizer setup
    - dataset loading & formatting
    - baseline or curriculum training
    - saving metadata/results
    - managing resources (memory cleanup, W&B)
    """
    ...
    def save_experiment_metadata(self, output_dir: Path, metadata: dict):
    ...
    def create_metadata(self, dataset_info: dict) -> dict:
        """
        Merge dataset info + configs into a single metadata object.
        """
        return {
            "strategy": self.experiment_config.strategy,
    ...
    def setup_experiment(self):
        """
        Prepare output directory and load tokenizer.
        """
    ...
    def initialize_wandb_run(self, metadata, mode=None):
        """
        Create a W&B run with clean naming & metadata.
        """
    ...
    def finalize_experiment(self, output_dir, results):
        """
        Save results + finish W&B logging.
        """
        filename = (
    ...
    def run(self):
        ...
        - dataset loading
        - W&B
        - selecting correct experiment type
        - saving everything
        """
    ...
    def run_baseline_experiment(self, dataset_splits, output_dir, run_name):
        """
    ...
    def run_curriculum_experiment(self, dataset_splits, output_dir, wandb_run):
        """
        Train progressively from easy → medium → hard.
        """
